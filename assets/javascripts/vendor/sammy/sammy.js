...
(function(factory) {
        ...
        bind: function() {
            ...
            if (_has_history && !app.disable_push_state) {
                ...
                $(document).delegate('a', 'click.history-' + this.app.eventNamespace(), function(e) {
                    ...
                    if (hostname == window.location.hostname && app.lookupRoute('get', full_path) && Sammy.targetIsThisWindow(e)) {
                        e.preventDefault();
    ...
    Sammy.Application.prototype = $.extend({}, Sammy.Object.prototype, {
        ...
        route: function(verb, path) {
            var app = this,
                param_names = [],
                add_route, path_match, callback = Array.prototype.slice.call(arguments, 2);
        ...
        runRoute: function(verb, path, params, target) {
            var app = this,
                ...
                context, wrapped_route, arounds, around, befores, before, callback_args, path_params, final_returned;
